...
.main-slider-box:hover .main-slider-overlay svg {
  position: absolute;
  top: 50%;
  left: 50%;
...
.main-slider-box .main-slider-overlay .circle {
  stroke: #e70634;
...
.main-slider-box .main-slider-overlay .triangle {
  -webkit-transition: all 1s ease-in-out;
...
.main-slider-box:hover .main-slider-overlay .triangle {
  stroke-dashoffset: 0;
  opacity: 1;
  stroke: #e70634;
...
.main-slider-box:hover .main-slider-overlay .circle {
  stroke-dashoffset: 0;
  opacity: 1;
}
